...
c) Add a marker at the university's location. See https://leafletjs.com/reference.html#marker for some advice.
*/
...
c) Depending on your location and the zoom level of the map, the user's location and the university's location might not be visible. Have a go at using fitBounds() to rescale the map to fit the markers (https://leafletjs.com/reference.html#latlngbounds).
*/
