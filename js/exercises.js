...
function initMap()
{
	myMap = L.map('map').setView([53.643806,-1.778755], 17);
...
c) Add a marker at the the location of Stone Henge. See https://leafletjs.com/reference.html#marker for some advice.
*/
...
b) Can you add a marker at the user's location? You should now have two markers. One for Stone Henge  and one for the user's location.
c) Depending on your location and the zoom level of the map, the user's location and the Stone Henge's location might not be visible. Have a go at using fitBounds() to rescale the map to fit the markers (https://leafletjs.com/reference.html#latlngbounds).
*/
